package bsu.rfict.cource2.group6.Volkov.varA8;
...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT,
                BasicStroke.JOIN_ROUND, 10.0f, new float[] {24, 6, 12, 6, 12, 6, 24, 6, 6}, 0.0f);
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        Rectangle2D boundsY1 = axisFont.getStringBounds("1", context);

        Point2D.Double labelY1Pos = xyToPoint(0, 1);

        canvas.drawString("1", (float)labelY1Pos.getX() - 30, (float)(labelY1Pos.getY() - boundsY1.getY()/3));

        canvas.draw(new Line2D.Double(shiftPoint(labelY1Pos, -5, 0), shiftPoint(labelY1Pos, 5, 0)));
